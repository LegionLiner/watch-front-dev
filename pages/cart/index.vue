      ...
      <div class="adaptive-container px-4 lg:px-0">
        ...
        >
          <div class="border-[1px] border-gray-1 p-6 flex flex-col gap-6">
            ...
            <AppButton to="/watches" size="md" class="w-full !max-w-full" dark
        ...
        >
          <div class="flex flex-col gap-10 flex-1 h-full w-3/4">
            <div class="flex flex-col gap-4 flex-1 h-full relative">
              ...
              >
                ...
                <div class="flex gap-6 flex-1">
                  ...
                  />
                  <div class="w-[160px] h-[160px] bg-gray-1" v-else></div>
            ...
            <div class="bg-gray-1 p-6 flex gap-3 items-center">
              ...
              >
                <rect width="40" height="40" rx="20" fill="#BD9542" />
                <path
                  d="M19.9922 24V20"
                  stroke="white"
                  stroke-width="1.5"
              ...
              <div class="p-6 border-[1px] border-gray-1">
                <div class="flex flex-col gap-8 items-center">
                  <svg
                    ...
                    xmlns="https://www.w3.org/2000/svg"
                  >
                    <rect y="36.5" width="64" height="12" fill="#F0F0F0" />
                    <path
              ...
              <div class="p-6 border-[1px] border-gray-1">
                <div class="flex flex-col gap-8 items-center">
                  <svg
                    ...
                    xmlns="https://www.w3.org/2000/svg"
                  >
                    <rect y="36" width="64" height="12" fill="#F0F0F0" />
                    <path
